        ...
        <div className="mb-4 flex items-center gap-4">
          ...
          <div className="flex-1">
            <div className="flex items-center gap-3">
              ...
              {/* AI badge */}
              <span className="inline-flex items-center gap-1.5 rounded-full border border-cyan-500/30 bg-gradient-to-r from-cyan-950/80 to-blue-950/80 px-2 py-0.5 font-mono text-[10px] font-semibold tracking-wider text-cyan-400 backdrop-blur-sm">
